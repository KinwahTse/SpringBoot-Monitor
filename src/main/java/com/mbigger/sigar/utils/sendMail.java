package com.mbigger.sigar.utils;
...
public class sendMail {
    ...
    public static String myEmailAccount = "kinwah0410@126.com";
    public static String myEmailPassword = "LDXFWXGAIAODGFYC";
    ...
    // 收件人邮箱（替换为自己知道的有效邮箱）
    //public static String receiveMailAccount = "178218119@qq.com";

    public void  CreateMail(String receiveMailAccount, String content) throws Exception {
    ...
    public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail, String content) throws Exception {
        ...
        // 2. From: 发件人
        message.setFrom(new InternetAddress(sendMail, "Kinwah", "UTF-8"));

        // 3. To: 收件人（可以增加多个收件人、抄送、密送）
        message.setRecipient(MimeMessage.RecipientType.TO, new InternetAddress(receiveMail, "XX用户", "UTF-8"));

        // 4. Subject: 邮件主题
        message.setSubject("监控告警", "UTF-8");
